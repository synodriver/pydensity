...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pydensity.backends.cython._core_cy",
        "sources": [
            "pydensity/backends/cython/_core_cy.pyx",
            "./dep/src\\globals.c",
    ...
    "module_name": "pydensity.backends.cython._core_cy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pydensity__backends__cython___core_cy
#define __PYX_HAVE_API__pydensity__backends__cython___core_cy
/* Early includes */
#include <string.h>
#include <stdio.h>
#include <stdint.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor;
struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor;
...
struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor {
  PyObject_HEAD
  struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_vtab;
...
struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor {
  PyObject_HEAD
  struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_vtab;
  DENSITY_STATE c_state;
  density_context *context;
};
...
struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_Compressor {
  PyObject *(*compress)(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *, __Pyx_memviewslice, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_vtabptr_9pydensity_8backends_6cython_8_core_cy_Compressor;
...
struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_DeCompressor {
  PyObject *(*decompress)(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *, __Pyx_memviewslice, uint_fast64_t, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_vtabptr_9pydensity_8backends_6cython_8_core_cy_DeCompressor;
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_decompress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *, __Pyx_memviewslice, uint_fast64_t, int __pyx_skip_dispatch);
...
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_10Compressor_compress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch); /* proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_decompress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size, CYTHON_UNUSED int __pyx_skip_dispatch); /* proto*/
...
/* Module declarations from 'pydensity.backends.cython._core_cy' */
static PyTypeObject *__pyx_ptype_9pydensity_8backends_6cython_8_core_cy_Compressor = 0;
static PyTypeObject *__pyx_ptype_9pydensity_8backends_6cython_8_core_cy_DeCompressor = 0;
...
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_format_state(DENSITY_STATE); /*proto*/
static CYTHON_INLINE uint8_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_major_version(int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint8_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_minor_version(int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint8_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_revision_version(int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE size_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_get_dictionary_size(PyObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_compress_safe_size(uint_fast64_t const , int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_decompress_safe_size(uint_fast64_t const , int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE void *__pyx_f_9pydensity_8backends_6cython_8_core_cy_mem_alloc(size_t); /*proto*/
static CYTHON_INLINE void __pyx_f_9pydensity_8backends_6cython_8_core_cy_mem_free(void *); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_compress(__Pyx_memviewslice, PyObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_compress_into(__Pyx_memviewslice, __Pyx_memviewslice, PyObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_decompress(__Pyx_memviewslice, uint_fast64_t, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_decompress_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pydensity.backends.cython._core_cy"
extern int __pyx_module_is_main_pydensity__backends__cython___core_cy;
int __pyx_module_is_main_pydensity__backends__cython___core_cy = 0;

/* Implementation of 'pydensity.backends.cython._core_cy' */
...
static const char __pyx_k_input_buffer_too_small[] = "input_buffer_too_small";
...
static const char __pyx_k_pydensity_backends_cython__core[] = "pydensity.backends.cython._core_cy";
...
static PyObject *__pyx_n_u_input_buffer_too_small;
...
static PyObject *__pyx_n_s_pydensity_backends_cython__core;
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_major_version(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_2minor_version(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_4revision_version(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_6get_dictionary_size(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_algorithm); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_8compress_safe_size(CYTHON_UNUSED PyObject *__pyx_self, uint_fast64_t __pyx_v_input_size); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10decompress_safe_size(CYTHON_UNUSED PyObject *__pyx_self, uint_fast64_t __pyx_v_input_size); /* proto */
static int __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor___cinit__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, PyObject *__pyx_v_algorithm, int __pyx_v_custom_dictionary); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state___get__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_2compress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data); /* proto */
static void __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_4__dealloc__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static int __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor___cinit__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, int __pyx_v_custom_dictionary); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state___get__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_2decompress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size); /* proto */
static void __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_4__dealloc__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_algorithm); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_14compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out, PyObject *__pyx_v_algorithm); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_16decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size); /* proto */
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_18decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out); /* proto */
...
static PyObject *__pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_Compressor(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_DeCompressor(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_format_state(DENSITY_STATE __pyx_v_state) {
 ...
 */
    ...
    __Pyx_INCREF(__pyx_n_u_input_buffer_too_small);
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_1major_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_1major_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_major_version[] = "major_version() -> uint8_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_1major_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("major_version (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_major_version(__pyx_self);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_major_version(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.major_version", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_3minor_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_3minor_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_2minor_version[] = "minor_version() -> uint8_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_3minor_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("minor_version (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_2minor_version(__pyx_self);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_2minor_version(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.minor_version", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_5revision_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_5revision_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_4revision_version[] = "revision_version() -> uint8_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_5revision_version(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("revision_version (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_4revision_version(__pyx_self);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_4revision_version(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.revision_version", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_7get_dictionary_size(PyObject *__pyx_self, PyObject *__pyx_v_algorithm); /*proto*/
static CYTHON_INLINE size_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_get_dictionary_size(PyObject *__pyx_v_algorithm, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_WriteUnraisable("pydensity.backends.cython._core_cy.get_dictionary_size", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_7get_dictionary_size(PyObject *__pyx_self, PyObject *__pyx_v_algorithm); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_6get_dictionary_size[] = "get_dictionary_size(algorithm) -> size_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_7get_dictionary_size(PyObject *__pyx_self, PyObject *__pyx_v_algorithm) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_dictionary_size (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_6get_dictionary_size(__pyx_self, ((PyObject *)__pyx_v_algorithm));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_6get_dictionary_size(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_algorithm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.get_dictionary_size", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_9compress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_9compress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_8compress_safe_size[] = "compress_safe_size(uint_fast64_t input_size) -> uint_fast64_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_9compress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.compress_safe_size", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_8compress_safe_size(__pyx_self, ((uint_fast64_t)__pyx_v_input_size));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_8compress_safe_size(CYTHON_UNUSED PyObject *__pyx_self, uint_fast64_t __pyx_v_input_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_11decompress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_11decompress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10decompress_safe_size[] = "decompress_safe_size(uint_fast64_t input_size) -> uint_fast64_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_11decompress_safe_size(PyObject *__pyx_self, PyObject *__pyx_arg_input_size) {
  uint_fast64_t __pyx_v_input_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.decompress_safe_size", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10decompress_safe_size(__pyx_self, ((uint_fast64_t)__pyx_v_input_size));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10decompress_safe_size(CYTHON_UNUSED PyObject *__pyx_self, uint_fast64_t __pyx_v_input_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static CYTHON_INLINE void *__pyx_f_9pydensity_8backends_6cython_8_core_cy_mem_alloc(size_t __pyx_v_size) {
  void *__pyx_r;
  __Pyx_RefNannyDeclarations
  #ifdef WITH_THREAD
...
static CYTHON_INLINE void __pyx_f_9pydensity_8backends_6cython_8_core_cy_mem_free(void *__pyx_v_p) {
  __Pyx_RefNannyDeclarations
  #ifdef WITH_THREAD
  PyGILState_STATE __pyx_gilstate_save;
  #endif
...
/* Python wrapper */
static int __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor___cinit__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self), __pyx_v_algorithm, __pyx_v_custom_dictionary);
...
static int __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor___cinit__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, PyObject *__pyx_v_algorithm, int __pyx_v_custom_dictionary) {
  DENSITY_ALGORITHM __pyx_v_v;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state___get__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state___get__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.Compressor.state.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_3compress(PyObject *__pyx_v_self, PyObject *__pyx_arg_data); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_10Compressor_compress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  uint_fast64_t __pyx_v_input_size;
 ...
 */
  ...
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.Compressor.compress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_3compress(PyObject *__pyx_v_self, PyObject *__pyx_arg_data); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_2compress[] = "Compressor.compress(self, const uint8_t[::1] data) -> bytes";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_3compress(PyObject *__pyx_v_self, PyObject *__pyx_arg_data) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_2compress(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self), __pyx_v_data);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_2compress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
/* Python wrapper */
static void __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_4__dealloc__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_4__dealloc__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_6__reduce_cython__[] = "Compressor.__reduce_cython__(self)";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_6__reduce_cython__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.Compressor.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_8__setstate_cython__[] = "Compressor.__setstate_cython__(self, __pyx_state)";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_8__setstate_cython__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_10Compressor_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.Compressor.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static int __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_custom_dictionary;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor___cinit__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self), __pyx_v_data, __pyx_v_custom_dictionary);
...
static int __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor___cinit__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, int __pyx_v_custom_dictionary) {
  density_processing_result __pyx_v_result;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state___get__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state___get__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.DeCompressor.state.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_3decompress(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_decompress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  uint_fast64_t __pyx_v_input_size;
  PyObject *__pyx_v_out = 0;
  uint8_t *__pyx_v_out_ptr;
  density_processing_result __pyx_v_result;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_3decompress(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_2decompress[] = "DeCompressor.decompress(self, const uint8_t[::1] data, uint_fast64_t decompress_safe_size) -> bytes";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_3decompress(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_2decompress(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self), __pyx_v_data, __pyx_v_decompress_safe_size);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_2decompress(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
/* Python wrapper */
static void __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_4__dealloc__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_4__dealloc__(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_6__reduce_cython__[] = "DeCompressor.__reduce_cython__(self)";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_6__reduce_cython__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.DeCompressor.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_8__setstate_cython__[] = "DeCompressor.__setstate_cython__(self, __pyx_state)";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_8__setstate_cython__(((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pydensity.backends.cython._core_cy.DeCompressor.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_13compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_compress(__Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_algorithm, CYTHON_UNUSED int __pyx_skip_dispatch) {
  DENSITY_ALGORITHM __pyx_v_v;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_13compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12compress[] = "compress(const uint8_t[::1] data, algorithm) -> bytes";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_13compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_algorithm = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_12compress(__pyx_self, __pyx_v_data, __pyx_v_algorithm);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_12compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_algorithm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_15compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_compress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out, PyObject *__pyx_v_algorithm, CYTHON_UNUSED int __pyx_skip_dispatch) {
  DENSITY_ALGORITHM __pyx_v_v;
  uint_fast64_t __pyx_v_text_length;
  density_processing_result __pyx_v_result;
  uint_fast64_t __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_15compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_14compress_into[] = "compress_into(const uint8_t[::1] data, uint8_t[::1] out, algorithm) -> uint_fast64_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_15compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_14compress_into(__pyx_self, __pyx_v_data, __pyx_v_out, __pyx_v_algorithm);
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_17decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_9pydensity_8backends_6cython_8_core_cy_decompress(__Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  uint_fast64_t __pyx_v_text_length;
  PyObject *__pyx_v_out = 0;
  uint8_t *__pyx_v_out_ptr;
  density_processing_result __pyx_v_result;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_17decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_16decompress[] = "decompress(const uint8_t[::1] data, uint_fast64_t decompress_safe_size) -> bytes";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_17decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  uint_fast64_t __pyx_v_decompress_safe_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_16decompress(__pyx_self, __pyx_v_data, __pyx_v_decompress_safe_size);
...
static PyObject *__pyx_pf_9pydensity_8backends_6cython_8_core_cy_16decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, uint_fast64_t __pyx_v_decompress_safe_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_19decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE uint_fast64_t __pyx_f_9pydensity_8backends_6cython_8_core_cy_decompress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  uint_fast64_t __pyx_v_text_length;
  density_processing_result __pyx_v_result;
  uint_fast64_t __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_19decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9pydensity_8backends_6cython_8_core_cy_18decompress_into[] = "decompress_into(const uint8_t[::1] data, uint8_t[::1] out) -> uint_fast64_t";
static PyObject *__pyx_pw_9pydensity_8backends_6cython_8_core_cy_19decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pydensity_8backends_6cython_8_core_cy_18decompress_into(__pyx_self, __pyx_v_data, __pyx_v_out);
...
static struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_Compressor __pyx_vtable_9pydensity_8backends_6cython_8_core_cy_Compressor;

static struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *__pyx_freelist_9pydensity_8backends_6cython_8_core_cy_Compressor[8];
static int __pyx_freecount_9pydensity_8backends_6cython_8_core_cy_Compressor = 0;

static PyObject *__pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_Compressor(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *p;
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_Compressor > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor)))) {
    o = (PyObject*)__pyx_freelist_9pydensity_8backends_6cython_8_core_cy_Compressor[--__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_Compressor];
    memset(o, 0, sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor));
    (void) PyObject_INIT(o, t);
  } else {
    o = (*t->tp_alloc)(t, 0);
    if (unlikely(!o)) return 0;
  }
  p = ((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)o);
  p->__pyx_vtab = __pyx_vtabptr_9pydensity_8backends_6cython_8_core_cy_Compressor;
  if (unlikely(__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_9pydensity_8backends_6cython_8_core_cy_Compressor(PyObject *o) {
  {
    PyObject *etype, *eval, *etb;
    PyErr_Fetch(&etype, &eval, &etb);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) + 1);
    __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5__dealloc__(o);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) - 1);
    PyErr_Restore(etype, eval, etb);
  }
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_Compressor < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor)))) {
    __pyx_freelist_9pydensity_8backends_6cython_8_core_cy_Compressor[__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_Compressor++] = ((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static PyObject *__pyx_getprop_9pydensity_8backends_6cython_8_core_cy_10Compressor_state(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_5state_1__get__(o);
}

static PyMethodDef __pyx_methods_9pydensity_8backends_6cython_8_core_cy_Compressor[] = {
  {"compress", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_3compress, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_2compress},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_7__reduce_cython__, METH_NOARGS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_6__reduce_cython__},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_10Compressor_9__setstate_cython__, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10Compressor_8__setstate_cython__},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_9pydensity_8backends_6cython_8_core_cy_Compressor[] = {
  {(char *)"state", __pyx_getprop_9pydensity_8backends_6cython_8_core_cy_10Compressor_state, 0, (char *)0, 0},
  {0, 0, 0, 0, 0}
};

static PyTypeObject __pyx_type_9pydensity_8backends_6cython_8_core_cy_Compressor = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy.Compressor", /*tp_name*/
  sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_Compressor), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_9pydensity_8backends_6cython_8_core_cy_Compressor, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_9pydensity_8backends_6cython_8_core_cy_Compressor, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_9pydensity_8backends_6cython_8_core_cy_Compressor, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_Compressor, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static struct __pyx_vtabstruct_9pydensity_8backends_6cython_8_core_cy_DeCompressor __pyx_vtable_9pydensity_8backends_6cython_8_core_cy_DeCompressor;

static struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *__pyx_freelist_9pydensity_8backends_6cython_8_core_cy_DeCompressor[8];
static int __pyx_freecount_9pydensity_8backends_6cython_8_core_cy_DeCompressor = 0;

static PyObject *__pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_DeCompressor(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *p;
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_DeCompressor > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor)))) {
    o = (PyObject*)__pyx_freelist_9pydensity_8backends_6cython_8_core_cy_DeCompressor[--__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_DeCompressor];
    memset(o, 0, sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor));
    (void) PyObject_INIT(o, t);
  } else {
    o = (*t->tp_alloc)(t, 0);
    if (unlikely(!o)) return 0;
  }
  p = ((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)o);
  p->__pyx_vtab = __pyx_vtabptr_9pydensity_8backends_6cython_8_core_cy_DeCompressor;
  if (unlikely(__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_9pydensity_8backends_6cython_8_core_cy_DeCompressor(PyObject *o) {
  {
    PyObject *etype, *eval, *etb;
    PyErr_Fetch(&etype, &eval, &etb);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) + 1);
    __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5__dealloc__(o);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) - 1);
    PyErr_Restore(etype, eval, etb);
  }
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_DeCompressor < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor)))) {
    __pyx_freelist_9pydensity_8backends_6cython_8_core_cy_DeCompressor[__pyx_freecount_9pydensity_8backends_6cython_8_core_cy_DeCompressor++] = ((struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static PyObject *__pyx_getprop_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_state(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_5state_1__get__(o);
}

static PyMethodDef __pyx_methods_9pydensity_8backends_6cython_8_core_cy_DeCompressor[] = {
  {"decompress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_3decompress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_2decompress},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_7__reduce_cython__, METH_NOARGS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_6__reduce_cython__},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_9__setstate_cython__, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_8__setstate_cython__},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_9pydensity_8backends_6cython_8_core_cy_DeCompressor[] = {
  {(char *)"state", __pyx_getprop_9pydensity_8backends_6cython_8_core_cy_12DeCompressor_state, 0, (char *)0, 0},
  {0, 0, 0, 0, 0}
};

static PyTypeObject __pyx_type_9pydensity_8backends_6cython_8_core_cy_DeCompressor = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy.DeCompressor", /*tp_name*/
  sizeof(struct __pyx_obj_9pydensity_8backends_6cython_8_core_cy_DeCompressor), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_9pydensity_8backends_6cython_8_core_cy_DeCompressor, /*tp_dealloc*/
  #if PY_VERSION_HEX < 0x030800b4
  0, /*tp_print*/
  #endif
  #if PY_VERSION_HEX >= 0x030800b4
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_9pydensity_8backends_6cython_8_core_cy_DeCompressor, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_9pydensity_8backends_6cython_8_core_cy_DeCompressor, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_9pydensity_8backends_6cython_8_core_cy_DeCompressor, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pydensity.backends.cython._core_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"major_version", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_1major_version, METH_NOARGS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_major_version},
  {"minor_version", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_3minor_version, METH_NOARGS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_2minor_version},
  {"revision_version", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_5revision_version, METH_NOARGS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_4revision_version},
  {"get_dictionary_size", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_7get_dictionary_size, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_6get_dictionary_size},
  {"compress_safe_size", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_9compress_safe_size, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_8compress_safe_size},
  {"decompress_safe_size", (PyCFunction)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_11decompress_safe_size, METH_O, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_10decompress_safe_size},
  {"compress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_13compress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_12compress},
  {"compress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_15compress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_14compress_into},
  {"decompress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_17decompress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_16decompress},
  {"decompress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pydensity_8backends_6cython_8_core_cy_19decompress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pydensity_8backends_6cython_8_core_cy_18decompress_into},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__core_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__core_cy},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_input_buffer_too_small, __pyx_k_input_buffer_too_small, sizeof(__pyx_k_input_buffer_too_small), 0, 1, 0, 1},
  ...
  {&__pyx_n_s_pydensity_backends_cython__core, __pyx_k_pydensity_backends_cython__core, sizeof(__pyx_k_pydensity_backends_cython__core), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_core_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_core_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__core_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__core_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__core_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_core_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__core_cy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_core_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pydensity__backends__cython___core_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pydensity.backends.cython._core_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "pydensity.backends.cython._core_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pydensity.backends.cython._core_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pydensity.backends.cython._core_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
